...
const dict = {
  zh: {
    ...
    "aiPage.title": "AI 助手",
    "aiPage.subtitle": "风险哨兵 · 日报 · 对话查询。AI 仅建议，不代下单。",
    "aiPage.chatPlaceholder": "问问当前机器人状态、该不该调区间…",
    "aiPage.send": "发送",
    "aiPage.sentinel": "风险哨兵",
    "aiPage.report": "生成日报",
    "aiPage.running": "运行中…",
    "aiPage.sentinelOk": "一切正常",
    "aiPage.sentinelAlert": "发现风险",
  ...
  en: {
    ...
    "aiPage.title": "AI assistant",
    "aiPage.subtitle": "Risk sentinel · daily report · chat. AI proposes only, never trades.",
    "aiPage.chatPlaceholder": "Ask about bot status, whether to adjust a range…",
    "aiPage.send": "Send",
    "aiPage.sentinel": "Risk sentinel",
    "aiPage.report": "Daily report",
    "aiPage.running": "Running…",
    "aiPage.sentinelOk": "All clear",
    "aiPage.sentinelAlert": "Risks found",
